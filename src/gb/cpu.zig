...
pub fn create_gb_state(allocator: std.mem.Allocator, cart_state: *cart.CartState) !GBState {
    ...
    const mmio_bytes = std.mem.asBytes(&mmio);

    // See this page for the initial state of the io registers:
    // http://www.codeslinger.co.uk/pages/projects/gameboy/hardware.html
    mmio.TIMA = 0;
    mmio.TMA = 0;
    mmio_bytes[0x07] = 0x00;
    mmio_bytes[0x10] = 0x80;
    mmio_bytes[0x11] = 0xBF;
    mmio_bytes[0x12] = 0xF3;
    mmio_bytes[0x14] = 0xBF;
    mmio_bytes[0x16] = 0x3F;
    mmio_bytes[0x17] = 0x00;
    mmio_bytes[0x19] = 0xBF;
    mmio_bytes[0x1A] = 0x7F;
    mmio_bytes[0x1B] = 0xFF;
    mmio_bytes[0x1C] = 0x9F;
    mmio_bytes[0x1E] = 0xBF;
    mmio_bytes[0x20] = 0xFF;
    mmio_bytes[0x21] = 0x00;
    mmio_bytes[0x22] = 0x00;
    mmio_bytes[0x23] = 0xBF;
    mmio_bytes[0x24] = 0x77;
    mmio_bytes[0x25] = 0xF3;
    mmio_bytes[0x26] = 0xF1;
    mmio_bytes[0x40] = 0x91;
    mmio_bytes[0x42] = 0x00;
    mmio_bytes[0x43] = 0x00;
    mmio_bytes[0x45] = 0x00;
    mmio_bytes[0x47] = 0xFC;
    mmio_bytes[0x48] = 0xFF;
    mmio_bytes[0x49] = 0xFF;
    mmio_bytes[0x4A] = 0x00;
    mmio_bytes[0x4B] = 0x00;
